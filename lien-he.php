...
<aside id="colorlib-hero" class="breadcrumbs">
							...
							<form action="" method="POST">
								<div class="row form-group">
									<div class="col-md-12 padding-bottom">
										...
										<input type="text" id="fname" name="name" class="form-control" placeholder="Điền Họ Và Tên Của Bạn" value="<?php echo $data['name'] ?>">
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<input type="text" id="email" name="email" class="form-control" placeholder="Điền Địa Chỉ Email Của Bạn" value="<?php echo $data['email'] ?>">
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<input type="text" id="subject" name="subject" class="form-control" placeholder="Tiêu Đề Của Bài Viết" value="<?php echo $data['subject'] ?>">
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<textarea name="message" id="message" name="message" cols="30" rows="10" class="form-control" placeholder="Nội Dung Lời Nhắn" value="<?php echo $data['message'] ?>"></textarea>
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3917.0823778928357!2d106.7868035141065!3d10.957149858829652!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174d9618d754cb7%3A0x55cb22a6ed20439a!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBM4bqhYyBI4buTbmcgQ8ahIHPhu58gNQ!5e0!3m2!1svi!2s!4v1553780019403" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
