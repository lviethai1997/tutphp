...
$sql = " SELECT a.*,a.id as id,a.name as name,a.sale as sale,d.salecat as salecat,c.id as wishid from products a,users b,wishlist c, categories d where a.category_id = d.id and c.user_id = b.id and c.product_id = a.id and c.user_id = $user_id and a.status = 1 ";
            ...
            <div class="col-md-15 col-md-push-2">
                <div class="row row-pb-lg">
                    ...
                    <div class="col-md-3 text-center" >
                        <div class="product-entry hideproduct">
                            <div class="product-img"
                                ...
                                <div class="cart">
                                    <p>
                                        ...
                                        <span><a href="#" id="<?php echo $item['wishid']  ?>" class="deletewishlist" ><i class="fa fa-trash trash"></i></a></span>
                                    </p>
                                </div>
                            </div>
                            <div class="desc">
