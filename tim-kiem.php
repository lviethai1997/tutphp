				   			...
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
                                   ...
                                   <div class="col-sm-12">
                                    <form  action="" method="GET">
                                        <div class="row">
                                            <div class="col-xs-10">
                                                <input type="text" class="form-control fw" name="keyword" placeholder="Từ khóa" value="<?php if(empty($keyword)){echo '';}else{echo $keyword;} ?>">
                                            </div>
                                            <div class="col-xs-2">
                        ...
                        <?php foreach($product as $item ): ?>
							<div class="col-md-4 text-center">
								...
								}else
								{
								 ...
								 { echo 'Sale'." ".$item['sale']."%";}
								 elseif($Catsale['salecat']>0){echo 'Sale'." " .($Catsale['salecat'])."%";}
									...
									<div class="desc">
										...
										<p class="price"><span class="sale"><strike><?php echo formatPrice($item['price']) ?></strike></span>
										<span>&emsp;<?php  echo formatpricesale($item['price'],($Catsale['salecat'])) ?></span>  </p>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<?php for($i=1 ; $i <= $sotrang ; $i++): ?>
									<li class="<?php echo isset($_GET['p']) && $_GET['p'] == $i ? 'active' : '' ?>"><a href="<?php echo $path; ?>?keyword=<?php echo $keyword ?>&&p=<?php echo $i ?>"><?php echo $i; ?></a></li>
								<?php endfor ?>
