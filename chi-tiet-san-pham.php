                                    ...
                                    <form action="" method="post">
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="contentcm" id="message" cols="20" rows="10"
                                                    class="form-control"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center colorlib-heading">
                ...
                <p>Dưới đây là những sản phẩm cùng danh mục mà chúng tôi muốn giới thiệu cho bạn, và nếu bạn có thích
                    sản phẩm nào đó thì hãy mua nó ngay nhé!</p>
            </div>
        </div>
        <div class="row">
