							...
							<form action="" method="post">
								<div class="row form-group">
									<div class="col-md-12 padding-bottom">
										...
										<input  type="text" id="fname" name="name" class="form-control" placeholder="Nhập họ và tên" value="<?php echo $user['name'] ?>">
                                        <?php 
                                        if(isset($error['name'])): ?>
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<input type="text" id="message" name="address" class="form-control" placeholder="Nhập địa chỉ" value="<?php echo $user['address'] ?>">
                                        <?php 
                                ...
                                <div class="row form-group">
									<div class="col-md-12">
										...
										<input  type="password" id="email" name="password" class="form-control" placeholder="Nhập Mật Khẩu" >
                                        <?php 
                                ...
                                <div class="row form-group">
									<div class="col-md-12">
										...
										<input  type="password" id="email" name="re_password" class="form-control" placeholder="Nhập Lại Mật Khẩu" >
                                        <?php 
								...
								<div class="row form-group">
									<div class="col-md-12">
										...
										<input  type="number" id="subject" name="phone" class="form-control" placeholder="Nhập số điện thoại" value="<?php echo $user['phone'] ?>">
                                        <?php 
