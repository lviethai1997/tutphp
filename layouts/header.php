					...
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li class="has-dropdown">
								<a href="thong-tin.php?id=<?php echo $_SESSION['name_id'] ?>"><b>Xin chào: <?php echo getLastName($_SESSION['name_user']) ?></b></a>
									<ul class="dropdown" style="top:20px;">
									<li><a  href="thong-tin.php?id=<?php echo $_SESSION['name_id'] ?>">Thông Tin</a></li>
