				...
				<div class="row row-pb-md">
					<div class="col-md-10 col-md-offset-1">
						...
						<div class="product-cart" >
								<div class="one-forth">
									<div class="product-img" style="background-image: url(<?php echo uploads() ?>product/<?php echo $value['thunbar'] ?>);">
									</div>
						...
						<div class="total-wrap">
							<div class="row">
								...
								<div class="col-md-3 col-md-push-1 text-center">
									<div class="total">
										<div class="sub">
											<p><span>Tổng Tiền:</span> <span><?php echo formatPrice1($_SESSION['tongtien']) ?>₫</span></p>
											<p><span>VAT 10%:</span> <span>10%</span></p>
											<p><span>Giảm Giá:</span> <span><?php echo sale($_SESSION['tongtien']) ?>%</span></p>
										</div>
										<div class="grand-total">
											<p><span><strong>Tổng tiền thanh toán:</strong></span> <span> <span><?php $_SESSION['total'] = ($_SESSION['tongtien'] *110/100)-($_SESSION['tongtien']/100*sale($_SESSION['tongtien'])); echo formatPrice1($_SESSION['total'])?>₫</p></span></p>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading">
						...
						<p>Dưới đây là những sản phẩm chúng tôi muốn giới thiệu đến bạn, và nếu bạn thích những sản phẩm này thì hãy mua chúng ngay nhé !</p>
					</div>
				</div>
				<div class="row">
