...
<body onload="window.print();">
    <div id="page" class="page">
        <div class="header">
            <div class="logo"><img withd="150" height="150"
                    src="<?php echo base_url()  ?>public/fontend/logo/logobill.png" /></div>
        ...
        <div>
            ...
            <p>Điện thoại: <?php echo $billuser['usersphone'] ?></p>
            </tr>
        </div>
    ...
    $tongsotien = 0;?>
            ...
            <tr>
                ...
                <td class="cotSo">
                    <?php $tongtien = ($tongsotien *110/100)-($tongsotien/100*sale($tongsotien)); echo formatPrice1($tongtien)?>
                </td>
            </tr>
        </table>
        <p>Hình thức thanh toán: <?php if($billuser['pt']==1){echo "COD";}else{echo 'Chuyển khoản';} ?></p>
        <br><br>
        <div class="footer-left"> Đồng nai, ngày <?php echo $billuser['ngay'] ?> tháng <?php echo $billuser['thang'] ?>
            năm <?php echo $billuser['nam'] ?><br />
            Khách hàng </div>
        <div class="footer-right"> Đồng nai, ngày <?php echo $billuser['ngay'] ?> tháng <?php echo $billuser['thang'] ?>
            năm <?php echo $billuser['nam'] ?><br />
            Nhân viên </div>
    </div>
</body>
