<?php  
    ...
    $getemail ="SELECT a.status,email FROM transaction a,users b WHERE  a.users_id = b.id and a.id = $id limit 1";
    ...
    if($getemailuser['status'] ==1 )
    {
        ...
        $_SESSION['error'] =" Đơn hàng chưa xử lý, không thể ship được!!!";
        redirectAdmin("transaction");
    }
