...
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group" >
    ...
    <input type="text" class="form-control" id="ten" name="name"  placeholder="Nhập Họ và tên" value="<?php echo $editAdmin['name'] ?>">
    <?php 
    if(isset($error['name'])): ?>
  ...
  <div class="form-group" >
    ...
    <input type="text" class="form-control" id="price" name="address"  placeholder="Nhập Địa chỉ" value="<?php echo $editAdmin['address'] ?>">
    <?php 
  ...
  <div class="form-group" >
    ...
    <input type="email" class="form-control" id="price" name="email"  placeholder="Nhập Địa chỉ email" value="<?php echo $editAdmin['email'] ?>">
    <?php 
  ...
  <div class="form-group" >
    ...
    <input type="number" class="form-control" id="price" name="phone"  placeholder="Nhập số điện thoại" value="<?php echo $editAdmin['phone'] ?>">
    <?php 
