...
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group" >
    ...
    <input type="text" class="form-control" id="ten" name="name"  placeholder="Nhập Họ và tên" value="<?php echo $data['name'] ?>">
    <?php 
    if(isset($error['name'])): ?>
  ...
  <div class="form-group" >
    ...
    <input type="text" class="form-control" id="price" name="address"  placeholder="Nhập Địa chỉ" value="<?php echo $data['address'] ?>">
    <?php 
  ...
  <div class="form-group" >
    ...
    <input type="email" class="form-control" id="price" name="email"  placeholder="Nhập Địa chỉ email" value="<?php echo $data['email'] ?>">
    <?php 
  ...
  <div class="form-group" >
    ...
    <input type="number" class="form-control" id="price" name="phone"  placeholder="Nhập số điện thoại" value="<?php echo $data['phone'] ?>">
    <?php 
  ...
  <div class="form-group" >
    ...
    <option value="1" <?php echo isset($data['level']) && $data['level']==1 ? "select = 'selected'" : '' ?>>CTV</option>
    <option value="2" <?php echo isset($data['level']) && $data['level']==2 ? "select = 'selected'" : '' ?>>Admin</option>
    </select>
    <?php 
